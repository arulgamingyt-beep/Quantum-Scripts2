...
Config.WeaponShops = {
    ['valentine'] = {
        enabled = true,
        label = 'Valentine Weapon Shop',
        job = 'valweaponsmith', -- Job required for boss menu (set to nil for public access)
        blip = {
            enabled = false, -- Set to true if you want a map blip for this shop
            sprite = 'blip_shop_gunsmith',
            scale = 0.2,
            color = 'BLIP_MODIFIER_MP_COLOR_32',
        },
        -- Weapon customization location (uses existing game prop - no spawn needed)
        prop = {
            enabled = false, -- Don't spawn prop, use existing game prop
            model = 'p_gunsmithprops09x',
            coords = vector4(-281.45, 780.07, 119.43, 358.30), -- Location for ox_target interaction
        },
        -- Boss menu location (for job management)
        boss = {
            enabled = true,
            coords = vector3(-280.14, 778.87, 119.50),
            heading = 5.31,
        },
        -- Stash location (optional)
        stash = {
            enabled = true,
            coords = vector3(-279.50, 783.61, 119.50),
            slots = 50,
            weight = 100000,
        },
    },
